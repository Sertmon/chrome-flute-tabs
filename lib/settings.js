...
export const FINGERING_SYSTEM_OPTIONS = [
  { value: 'german', label: 'Немецкая (German)' },
  { value: 'baroque', label: 'Барокко (English)' },
];
...
export function clampSettings(raw) {
  ...
  if (!FINGERING_SYSTEM_OPTIONS.some((o) => o.value === s.fingeringSystem)) {
    s.fingeringSystem = DEFAULT_SETTINGS.fingeringSystem;
  }
